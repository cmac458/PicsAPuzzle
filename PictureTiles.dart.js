...
$$.Basics = {"": ["_dragSourceEl", "tiles"],
 ...
 generateMap$0: function() {
  ...
  $.indexSet(this.tiles, 1, 'url(img/pgriffin_tiles_01.png)');
  $.indexSet(this.tiles, 2, 'url(img/pgriffin_tiles_02.png)');
  $.indexSet(this.tiles, 3, 'url(img/pgriffin_tiles_03.png)');
  $.indexSet(this.tiles, 4, 'url(img/pgriffin_tiles_04.png)');
  $.indexSet(this.tiles, 5, 'url(img/pgriffin_tiles_05.png)');
  $.indexSet(this.tiles, 6, 'url(img/pgriffin_tiles_06.png)');
  $.indexSet(this.tiles, 7, 'url(img/pgriffin_tiles_07.png)');
  $.indexSet(this.tiles, 8, 'url(img/pgriffin_tiles_08.png)');
  $.indexSet(this.tiles, 9, 'url(img/pgriffin_tiles_09.png)');
},
 getRandomTile$0: function() {
  ...
  var t1 = this.tiles;
  if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
    return this.getRandomTile$0$bailout(1, t1, rand, num);
  if (num !== (num | 0))
    throw $.iae(num);
...
$.CTC14 = new Isolate.$isolateProperties.ArgumentError('Invalid list length');
